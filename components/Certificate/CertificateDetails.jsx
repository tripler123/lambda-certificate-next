    ...
    <div className="certificate">
      <div className="certificate__left">
        ...
        <p>
          ...
          <strong>{certificate.student.name}</strong> ha completado con éxito el
          curso <strong>{certificate.course.name}</strong> a fecha de{" "}
          <strong>{moment(certificate.course.date).format("MMMM YYYY")}</strong>{" "}
          , habiendo sido impartido por teacher en{" "}
          <strong>Lambda Ingeniería & Innovación.</strong> El certificado indica
          que se ha completado la totalidad del curso, según lo validado por el
          estudiante. La duración del curso representa el total de horas de
          vídeo del curso en el momento de finalización más reciente.
        </p>
      </div>
